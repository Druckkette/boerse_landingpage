...
const purchaseLinks = [
  { label: "Bei Springer ansehen", href: BOOK_LINKS.springer, channel: "springer" },
  { label: "Bei Amazon ansehen", href: BOOK_LINKS.amazon, channel: "amazon" },
  { label: "Im Buchhandel suchen", href: BOOK_LINKS.bookstore, channel: "bookstore" }
];
  ...
  return (
    <section className="section purchase-section" id="kaufen" aria-labelledby="purchase-title">
      <div className="container purchase-layout">
        <div>
          <p className="section-kicker">Buch ansehen</p>
